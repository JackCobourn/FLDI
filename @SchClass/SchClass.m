classdef SchClass < handle
    ...
    %
    %   Added Support for Photron SA-Z and aditional functionality
    %   Autor: Jack Cobourn                      Creation Date:July 26,2020
    %
    %   Examples
    %   --------
    %   % Load image 10
   ...
   methods
      function delete(obj)
        ...
        fclose(obj.FidVideo);
            ...
            warning([num2str(datestr(now)), ': MRAW-File not closed/never opened']);
        end
      end
      
      function obj = SchClass(FullFileName)
        ...
        obj.ExtendedInfos = deblank(cihdata{1}(:,1:end-1));
      end
