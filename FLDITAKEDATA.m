...
JetPos = x_loc./d;
%% Connect scope
[VisaInterface, Wavesurfer510, Waveform] = OscopeVisaConnect_V2();
...
%take max data
    ...
    [Y,X,YUNIT,XUNIT,HEADER] = invoke(Waveform,'readwaveform','channel3');
...
while CurrentPosition>=HomePos
    ...
    for i = 1:1:waves2take
        ...
        set(Waveform,'Precision','int8'); %set to int8 to do back up data aqq
        [Y,X,YUNIT,XUNIT,HEADER] = invoke(Waveform,'readwaveform','channel3');
